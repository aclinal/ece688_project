...
%
% Controller: eqns (17) and (30) from Jiang.
%               (eqns (12) and (25) in my paper)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [dx,tau_s,tau_y] = backstepping_DE( t, X)
    ...
    % (eqn 30):
    tau_y=tau_yd+m33*(-(m11-m22)/m33*(u*v-u_d*v_d)+d33/m33*r_e-k1*z_3e-k2*r_e);
